...
<div class="row | header">
    ...
    <div class="section | col s12 m8">
        <!-- Note that "m4 l3" was added -->
        <!-- Grey navigation panel -->
        <h2 class="header__title">Bienvenido</h2>
        <p class="header__content">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
            Consectetur unde facere voluptas delectus iure vitae provident, nobis est, nesciunt
            cumque amet corrupti ad minima quis reiciendis, nostrum sit sequi dignissimos?
        </p>
    </div>
</div>
<div class="container">
